...
async def lifespan(app: FastAPI):
    ...
    try:
        ...
        NLU_MODEL_PATH = "rasa/models/nlu_new_trained.tar.gz"
...
async def transcribe_segment(audio_np_segment: np.ndarray, language: str) -> str:
    ...
    try:
        ...
        speech_timestamps = GET_SPEECH_TIMESTAMPS(
            ...
            threshold=0.4,  # Adjust threshold for sensitivity (lower = more sensitive to speech)
        ...
        # Transcription with improved parameters
        generate_kwargs = {
            "language": language,
            "temperature": 0.0,
            "num_beams": 5,
            "initial_prompt": "Transcribe the speech accurately without adding extra words or phrases. Focus on financial commands like top up, topup wallet, send money, card to card transfer."
        }
